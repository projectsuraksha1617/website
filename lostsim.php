...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Lost Sim Card</h1>
			</div>
	</div>	<!--/.main-->
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="lostsimdetails.php" method="post">
							<fieldset>
								<!-- Name input-->
								<div class="form-group">
									<label class="col-md-3 control-label" for="name">Case type</label>
									<div class="col-md-9">
									<input id="name" name="type" type="text" placeholder="Case Type" required class="form-control" pattern="[A-Za-z_ ]*" title="please enter only alphabets">
									</div>
									...
									<label class="col-md-3 control-label" for="name">Lost Location</label>
									<div class="col-md-9">
									<input id="name" name="location" type="text" required placeholder="Location where you lost your sim" class="form-control">
									</div>
									<label class="col-md-3 control-label" for="name">Mode of Losing</label>
									<div class="col-md-9">
									<input id="name" name="mode" type="text" required placeholder="How did you lose it?" class="form-control">
									</div>
									<label class="col-md-3 control-label" for="name">Service Provider</label>
									<div class="col-md-9">
									<input id="name" name="service" type="text" required  placeholder="Service Provider" class="form-control">
									</div>
								</div>
								<div class="form-group">
