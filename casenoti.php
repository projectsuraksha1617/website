...
<title>Case Notifications</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="casenoti.php"><svg class="glyph stroked table"></svg><i class="fa fa-inbox" aria-hidden="true"></i><strong> Case Notification</strong></a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Case Notifications</h1>
			</div>
	</div>	<!--/.main-->
