...
$query="insert into cops(First_Name,Middle_Name,Last_Name,Adhaar_No,role,E_mail,Create_Password,Confirm_Password,Address_Line1,Address_Line2,City,State,Postal_Code,Date_of_Birth,Mobile_Number,Photo,captcha) values('".$fname."','".$mname."','".$lname."','".$adhaar."','".$role."','".$email."','".$pwd."','".$cpwd."','".$ad1."','".$ad2."','".$city."','".$state."','".$zip."','".$dob."','".$contact."','".$photo."','".$cap."')";
